              ...
              <div className="relative h-[200px] overflow-hidden">
                ...
                <div className="relative z-10 flex h-full items-end p-6">
                  <div className="max-w-[760px]">
                    ...
                    <h1 className="text-3xl font-black leading-none tracking-tight text-white md:text-4xl">{game.title}</h1>
                    <p className="mt-2 text-base font-bold text-white/55 md:text-lg">{game.subtitle}</p>
