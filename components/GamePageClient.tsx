...
export default function GamePageClient({ slug, game }: Props) {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#0b1624_0%,#050505_45%,#020202_100%)] text-white">
      ...
      <section className="mx-auto w-full max-w-[1500px] px-4 py-6 md:px-6 lg:px-8">
        <div className="mb-5">
          <Link
            href="/"
        ...
        <div className="grid gap-5 xl:grid-cols-[230px_minmax(0,1fr)_250px]">
          {/* SIDEBAR ESQUERDA — CAPA DO JOGO */}
          <aside className="hidden xl:block">
            <div className="sticky top-24 overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/90 shadow-xl">
              ...
              <div className="p-5">
                <span
                  className={`inline-flex rounded-md border px-2.5 py-1 text-[10px] font-black uppercase tracking-[0.16em] ${
                    isJourneyCompleted
          ...
          <div className="min-w-0">
            <section className="overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/90 shadow-xl">
              <div className="flex min-h-[112px] items-center gap-5 p-5 md:p-6">
                <div className="hidden h-[84px] w-[62px] shrink-0 overflow-hidden rounded-lg border border-white/10 bg-black/40 sm:block">
                  {coverImage ? (
                    <img
                      src={coverImage}
                      alt={game.title}
                    ...
                    <div className="flex h-full items-center justify-center text-[9px] font-black text-white/25">
                      SEM CAPA
                    </div>
                  )}
                </div>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <h2 className="truncate text-2xl font-black leading-none tracking-tight text-white md:text-3xl">
                    {game.title}
                  </h2>
                ...
                <div className="hidden w-[110px] shrink-0 border-l border-white/10 pl-5 sm:block">
            ...
            <section
              id="achievements"
              className="mt-5 overflow-hidden rounded-2xl border border-white/10 bg-zinc-950/80 p-5 md:p-6"
            >
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-xl font-black text-white">Primeira Run</h2>
              ...
              <section className="rounded-2xl border border-white/10 bg-zinc-950/90 p-5 shadow-xl">
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-xl border border-white/5 bg-white/[0.025] p-3">
                    ...
                    <p className="mt-1 text-sm font-black text-white">{dynamicStatus}</p>
                  </div>
                </div>
              </section>
