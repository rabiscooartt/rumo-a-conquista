...
/* ---------- ÍCONES DE MÉTRICAS / IDENTIDADE ---------- */

function IconDaysStat(props: { className?: string }) {
  return (
    <SvgIcon {...props}>
      <rect
        x="4"
      ...
      />
      <path
        d="M7.5 3.7V7M16.5 3.7V7M4.5 9.6H19.5"
        stroke="currentColor"
        strokeWidth="1.55"
        strokeLinecap="round"
      />
      <path
        d="M8 12.6H9.8M12 12.6H13.8M16 12.6H16.1M8 16H9.8M12 16H13.8"
        stroke="currentColor"
        strokeWidth="1.45"
        strokeLinecap="round"
      />
      <path
        d="M17.2 12.1L17.8 13.3L19.1 13.5L18.1 14.45L18.35 15.75L17.2 15.1L16.05 15.75L16.3 14.45L15.3 13.5L16.6 13.3L17.2 12.1Z"
        fill="currentColor"
      />
    </SvgIcon>
  );
...
function IconTimeStat(props: { className?: string }) {
  return (
    <SvgIcon {...props}>
      <path
        d="M8.2 3.5H15.8M8.2 20.5H15.8"
        stroke="currentColor"
        strokeWidth="1.55"
        strokeLinecap="round"
      />
      <path
        d="M8.8 4.4C8.8 7.2 10.7 8.7 12 10C13.3 8.7 15.2 7.2 15.2 4.4M8.8 19.6C8.8 16.8 10.7 15.3 12 14C13.3 15.3 15.2 16.8 15.2 19.6"
        stroke="currentColor"
        strokeWidth="1.55"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function IconAverageStat(props: { className?: string }) {
  return (
    <SvgIcon {...props}>
      <path
        d="M4 18.5H20"
      ...
      />
      <path
        d="M5 16L8.5 12.6L11.4 14.8L15.2 9.8L19 7"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function IconGamesStat(props: { className?: string }) {
  return (
    <SvgIcon {...props}>
      <path
        d="M7.5 7.8H16.5C19 7.8 20.4 10.1 20.7 13.2L21.2 16.9C21.5 19.3 18.9 20.3 17.3 18.2L15.5 15.9H8.5L6.7 18.2C5.1 20.3 2.5 19.3 2.8 16.9L3.3 13.2C3.6 10.1 5 7.8 7.5 7.8Z"
        stroke="currentColor"
        strokeWidth="1.55"
        strokeLinejoin="round"
      />
      <path
        d="M7.1 11.3V15M5.2 13.15H9M15.2 11.9H15.22M18 14.8H18.02"
        stroke="currentColor"
        strokeWidth="1.55"
        strokeLinecap="round"
      />
      <path
        d="M10.1 8.1L12 5.3L13.9 8.1"
        stroke="currentColor"
        strokeWidth="1.35"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function Metric({
  ...
  return (
    <div className="flex min-w-0 items-center gap-2.5">
      <div
        className={`relative flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-xl border bg-black/25 shadow-[inset_0_0_18px_rgba(255,255,255,0.03)] ${styles[tone]}`}
      >
        <span className="pointer-events-none absolute inset-[3px] rounded-[9px] border border-white/[0.05]" />
        <span className="pointer-events-none absolute -right-2 -top-2 h-7 w-7 rounded-full bg-current opacity-[0.08] blur-md" />
